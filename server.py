...
# Using the optimized Flash model for maximum speed and lowest cost
    ...
    try:
        ...
        if image_b64:
            ...
            vision_message = HumanMessage(
                content=[
                    {"type": "text", "text": execution_input if execution_input else "Analyze this image."},
        ...
        # Format cleanup to guarantee string output
